...
This folder defines all source code for the 'NorthwindPipeline' pipeline:
...
* Take a look at the sample under "sample_users_northwindpipeline.py" to get familiar with the syntax.
